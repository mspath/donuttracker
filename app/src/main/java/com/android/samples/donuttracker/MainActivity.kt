...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // HOWTO set up the ActionBar manually, also see the layout file
        setSupportActionBar(binding.toolbar)
        // HOWTO set up the Notifier which then can be used activity wide
        //  need to take a look into this pattern which looks great for accessing resources
        Notifier.init(this)
    }
